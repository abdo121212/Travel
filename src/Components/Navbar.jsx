...
const Navbar = () => {
  ...
  return (
    <section section className="fixed top-0 right-0 w-full  z-10 bg-white ">
      <ResponsiveMeun shMenu={showMenu} setShMe={setShowMenu} />

      <div className="bg-gradient-to-r from-[#0287a8] to-[#00c3c7]  ">
          ...
          <div className="flex justify-between items-center ">
            ...
            <div className="flex  gap-4 ">
              ...
              <div className="flex items-center gap-5 ">
                <button className="bg-gradient-to-r  from-[#0287a8] to-[#00c3c7]  cursor-pointer hover:to-[#0287a8] hover:from-[#00c3c7] duration-500 transition-all  px-3 py-1 rounded-full text-white ">
                  Book Now
                </button>
